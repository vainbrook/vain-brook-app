...
const NAV = [
  { href: '/', label: 'Dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 001 1h3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', badge: false },
  ...
  { href: '/milestones', label: 'Milestones', icon: 'M9 5l7 7-7 7' },
]
    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        {NAV.slice(0, 2).map(item => (
          <Link key={item.href} href={item.href} className={`nav-item ${path === item.href ? 'nav-item-active' : ''}`}>
      ...
      <div className="sidebar-footer">
        <button className="role-btn" onClick={() => setShowRoles(!showRoles)} style={{ borderColor: ROLE_COLORS[role] }}>
